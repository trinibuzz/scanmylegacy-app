      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="font-serif text-4xl font-bold">Memorial Pages</h1>

            <p className="mt-3 max-w-2xl text-sm text-white/70">
              Manage memorial pages created to honor loved ones with photos,
              videos, tributes, candles, flowers, guestbook messages, and
              family memories.
            </p>
          </div>
